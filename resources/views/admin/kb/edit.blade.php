...
@section('content')
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-xl shadow-md border border-gray-100 p-8">
            <h2 class="text-xl font-bold text-gray-800 mb-6 border-b pb-4">Edit Data AI</h2>

            <form action="{{ route('knowledge-base.update', $item->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-8">
                    ...
                    <textarea name="answer" rows="5"
                        class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:border-indigo-500"
                        placeholder="Masukkan jawaban yang benar...">{{ $item->answer }}</textarea>
